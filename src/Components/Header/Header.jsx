    ...
    <div className="relative bg-black">
        ...
        <div className="relative px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <NavLink
                to="/" 
                className={({ isActive }) => 
                    `text-base font-medium ${isActive ? "text-yellow-400 font-semibold" : "text-white"}`
                }
            >
                Home
            </NavLink>
            ...
            >
                ...
                <a href="#" className="items-center justify-center hidden px-6 py-3 text-base font-semibold text-black transition-all duration-200 bg-yellow-400 border border-transparent rounded-full lg:inline-flex hover:bg-yellow-500 focus:bg-yellow-500" role="button"> Join Now </a>
            </nav>
        </div>
    </div>
